  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-sm-6.col-lg-2.mb-4.mb-lg-0
        .tarjeta--boton.color-gris.p-4 
          .row.justify-content-center.align-items-center
            ...
            .col-auto
              p.text-small.mt-3 La educación del consumidor.
              br
              br
              br
              br
      ...
      .col-sm-6.col-lg-2.mb-4.mb-lg-0
        .tarjeta--boton.color-gris.p-4
          .row.justify-content-center.align-items-center
            ...
            .col-auto 
              p.text-small.mt-3 La libertad de constituir organizaciones de consumidores y la oportunidad para esas organizaciones de hacer oír sus opiniones en los procesos de adopción de decisiones que las afecten.
      ...
      .col-sm-6.col-lg-2.mb-4.mb-lg-0
        .tarjeta--boton.color-gris.p-4
          .row.justify-content-center.align-items-center
            ...
            .col-auto
              p.text-small.mt-3 La protección especial a los niños, niñas y adolescentes, en su calidad de consumidores, de acuerdo con lo establecido en el Código de infancia y adolescencia.
    ...
    .col.lg-12.col-lg-10.offset-lg-1 
      .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5
        .bloque-texto-g__img(
          :style="{'background-image': `url(${require('@/assets/curso/temas/tema3/7.jpg')})`}"
        )
    ...
    datosLineaTiempoB: [
      {
        ...
        icono: require('@/assets/curso/temas/tema3/2.svg'),
      },
      {
        titulo: '',
        texto:
        ...
        icono: require('@/assets/curso/temas/tema3/3.svg'),
      },
      {
        titulo: '',
        texto:
          'Existen otros roles que por lo general se involucran, como los proveedores y los terceros, quienes se caracterizan por prestar un servicio interno, como la seguridad o vigilancia contratada, tecnología, servicios de aseo y/o cafetería. Cuando estos servicios son contratados con un tercero <em>(outsourcing)</em>, ellos deben cumplir el protocolo interno.',
        icono: require('@/assets/curso/temas/tema3/4.svg'),
      },
    ],
  }),
  mounted() {
